  ...
  const disableTouchArea = () => {
    ...
    return (
      <div className='fixed h-screen w-screen z-50'>
        ...
        <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 background border border-colour rnd min-w-[30rem]'>
        <div className='flex flex-col p-4 gap-2'>
              <div className='text-2xl flex items-start'>Cleaning Mode</div>
              <div className='text-lg flex items-start'>Touch screen will turn back on in {seconds} {' '}
