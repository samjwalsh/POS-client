    ...
    if (promise === null) return;
      ...
      return (
        <div className='fixed h-screen w-screen z-50'>
          ...
          <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 backgroundcolour border border-colour rounded shadow grid grid-cols-2 grid-rows-2 p-2 gap-2'>
