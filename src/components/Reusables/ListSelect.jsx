    ...
    if (promise === null) return;
      ...
      return (
        <div className='fixed h-screen w-screen z-50'>
          ...
          <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 background flex flex-col gap-2 rounded-box min-w-[15rem] p-4 overflow-hidden overflow-y-scroll max-h-[75vh] no-scrollbar'>
            {optionsHTML}
          </div>
        </div>
      );
