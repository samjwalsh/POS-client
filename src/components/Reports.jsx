...
export default function Reports(props) {
      ...
      ordersHTML = orders.map((order, index) => {
        ...
        return (
          <div
            ...
            <div className='flex flex-row w-full p-2 justify-between border border-colour blue rounded-sm'>
            ...
            <div className='flex flex-col p-2 border border-colour text-lg'>
  ...
  function reportsStatsHTML() {
    return (
      <div className='flex flex-col h-full'>
        ...
        <div className='mt-auto border border-colour p-2 flex flex-col gap-2'>
          <div
  ...
  function createReportsStatsInfo() {
    ...
    return (
      <div className='flex flex-col w-full text-xl p-2 gap-2'>
        <div className='flex flex-row w-full justify-between border border-colour pb-2'>
  ...
  function createItemsHTML(order) {
    let itemsHTML = order.items.map((item, index) => {
      ...
      return (
        <div
          className='w-full grid grid-cols-[auto_auto] grid-rows-[auto_min-content] text-lg p-2 border border-colour rounded'
          key={index}>
  ...
  return (
    <>
      ...
      <div className='overflow-y-scroll no-scrollbar h-full grid grid-cols-12 grid-rows-1'>
        ...
        <div className='col-span-4 border border-colour  w-full'>
          {reportsStatsHTML()}
        </div>
      </div>
    </>
