  ...
  return (
    <div className='flex flex-col h-full'>
      <div className='grid grid-cols-2 grid-rows-5 gap-2 h-full p-2 pb-1'>
        <div
          className='col-span-2 row-span-1 primary btnlg cnter-items'
          onContextMenu={() => handleButtonPress('custom')}
          onTouchStart={() => handleButtonPress('custom')}>
          Custom
        </div>
        <div
          className='col-span-1 row-span-1 num secondary btnlg cnter-items'
        ...
        <div
          className='col-span-2 row-span-2  positive  btnlg  cnter-items'
